//
//  ContentDetailTableViewController.m
//  YOHo
//
...
@interface ContentDetailTableViewController ()

@end

@implementation ContentDetailTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = self.contentDetail.data.contents.content;
